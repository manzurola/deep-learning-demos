...
from grammarchecker.cola_dataset import CoLADataSet
from grammarchecker.torch_config import get_torch, get_device
...
dataset = CoLADataSet(tokenizer)
training_dataloader = dataset.training_dataloader
...
# model.cuda()  # not on mac, also requires special pytorch installation
